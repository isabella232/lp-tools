...
extern {
    ...
    pub fn MagickCropImage(wand: *mut MagickWand, width: size_t, height: size_t, x: ssize_t, y: ssize_t) -> MagickBooleanType;
    ...
    pub fn MagickResizeImage(wand: *mut MagickWand, columns: size_t, rows: size_t, filter: FilterType) -> MagickBooleanType;
    pub fn MagickSetImageExtent(wand: *mut MagickWand, columns: size_t, rows: size_t) -> MagickBooleanType;
